...
echo "[Step 1] Elapsed time: $(epoch_to_hms $STEP1_TIME)"

# Step 2
STEP_START=$(date +%s)
echo "== Step 2: Anonymizing =="
...
echo "[Step 2] Elapsed time: $(epoch_to_hms $STEP2_TIME)"

# Step 3
STEP_START=$(date +%s)
echo "== Step 3: Splitting Text =="
...
echo "[Step 3] Elapsed time: $(epoch_to_hms $STEP3_TIME)"
...
# Step 9: Extract Key Discussion Points
STEP_START=$(date +%s)
echo "== Step 9: Extract Key Discussion Points =="
...
# Step 10: Summarize Key Discussion Points
STEP_START=$(date +%s)
echo "== Step 10: Summarize Key Discussion Points =="
...
# Step 11: Refine DOCX (Key Discussion Points)
STEP_START=$(date +%s)
echo "== Step 11: Refine DOCX (Key Discussion Points) =="
...
# Step 12: Extract Action Items and Next Steps
STEP_START=$(date +%s)
echo "== Step 12: Extract Action Items and Next Steps =="
...
# Step 13: Summarize Action Items and Next Steps
STEP_START=$(date +%s)
echo "== Step 13: Summarize Action Items and Next Steps =="
...
# Step 14: Refine DOCX (Action Items and Next Steps)
STEP_START=$(date +%s)
echo "== Step 14: Refine DOCX (Action Items and Next Steps) =="
...
# Step 15: Convert to PDF
STEP_START=$(date +%s)
echo "== Step 15: Convert to PDF =="
...
echo "✅ All steps completed. Output saved to $OUTPUT_DIR"
